...
export default function InvestigationAssessmentPanel({
  ...
  return (
    <div id="investigation-assessment" data-testid="investigation-assessment" className="space-y-3 rounded-xl border border-accent-primary/20 bg-accent-soft/20 p-3">
